...
{
    public abstract class BnBCheckInWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BnBCheckInWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BnBCheckInWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BnBCheckInDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BnBCheckInDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BnBCheckInDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BnBCheckInDbContext, Task<T>> func)
        {
            T result;
