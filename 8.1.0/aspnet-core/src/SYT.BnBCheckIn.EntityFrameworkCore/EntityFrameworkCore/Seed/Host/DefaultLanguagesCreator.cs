...
namespace SYT.BnBCheckIn.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = BnBCheckInConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(BnBCheckInDbContext context)
        {
            _context = context;
        }
